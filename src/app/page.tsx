...
export const metadata: Metadata = {
  title: 'ResearchConnect | Connecting Researchers with Funders',
      ...
      <header className="container mx-auto px-4 py-6">
        <div className="flex justify-between items-center">
          <div className="flex items-center space-x-2">
            <span className="text-2xl font-bold text-blue-700">ResearchConnect</span>
          </div>
          <nav className="hidden md:flex space-x-8">
            ...
            <a href="#testimonials" className="text-gray-600 hover:text-blue-700">Success Stories</a>
            <a href="#faq" className="text-gray-600 hover:text-blue-700">FAQ</a>
          </nav>
        </div>
      </header>
      ...
      <main>
        ...
        <section className="container mx-auto px-4 py-16 md:py-24">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-12">
              ResearchConnect bridges the gap between groundbreaking research projects and the funding they need to change the world.
            </p>
            
            <div className="flex flex-col md:flex-row justify-center space-y-6 md:space-y-0 md:space-x-8">
              {/* Researcher Login Button */}
              <Link href="/auth/researcher-login" 
        ...
        <section id="how-it-works" className="bg-gray-50 py-16">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-center mb-12">How ResearchConnect Works</h2>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <ol className="space-y-4">
                  <li className="flex items-start">
                    <span className="bg-blue-100 text-blue-700 rounded-full w-6 h-6 flex items-center justify-center mr-3 mt-0.5 flex-shrink-0">1</span>
                    <span>Create a profile showcasing your research background and current projects</span>
                  </li>
                  <li className="flex items-start">
                    <span className="bg-blue-100 text-blue-700 rounded-full w-6 h-6 flex items-center justify-center mr-3 mt-0.5 flex-shrink-0">2</span>
                    <span>Submit detailed proposals for funding with clear objectives and impact</span>
                  </li>
                  <li className="flex items-start">
                    <span className="bg-blue-100 text-blue-700 rounded-full w-6 h-6 flex items-center justify-center mr-3 mt-0.5 flex-shrink-0">3</span>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <ul className="space-y-4">
                  <li className="flex items-start">
                    ...
                    <span>Smart matching algorithm to connect compatible researchers and funders</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-purple-700 mr-3">✓</span>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <ol className="space-y-4">
                  <li className="flex items-start">
                    <span className="bg-green-100 text-green-700 rounded-full w-6 h-6 flex items-center justify-center mr-3 mt-0.5 flex-shrink-0">1</span>
                    <span>Create an organization profile with funding interests and requirements</span>
                  </li>
                  <li className="flex items-start">
                    <span className="bg-green-100 text-green-700 rounded-full w-6 h-6 flex items-center justify-center mr-3 mt-0.5 flex-shrink-0">2</span>
                    <span>Browse curated research projects that match your funding criteria</span>
                  </li>
                  <li className="flex items-start">
                    <span className="bg-green-100 text-green-700 rounded-full w-6 h-6 flex items-center justify-center mr-3 mt-0.5 flex-shrink-0">3</span>
                ...
                <ul className="space-y-4">
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Showcase your work to a curated network of funders interested in your field</p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Reduce time spent on grant applications by connecting directly with interested funders</p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    <span className="bg-blue-100 p-2 rounded-full mr-4">🤝</span>
                    <div>
                      ...
                      <p className="text-gray-600">Build relationships with funders who understand and value your research area</p>
                    </div>
                  </li>
                </ul>
              </div>
                ...
                <ul className="space-y-4">
                  ...
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Monitor the progress and outcomes of funded projects with built-in reporting tools</p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    <span className="bg-green-100 p-2 rounded-full mr-4">🌟</span>
                    <div>
                      ...
                      <p className="text-gray-600">Discover groundbreaking research before it reaches mainstream funding channels</p>
                    </div>
                  </li>
                </ul>
              </div>
        ...
        <section className="py-16 bg-blue-700 text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl mb-8 max-w-2xl mx-auto">
              Join our growing community of researchers and funders changing the future of scientific innovation.
            </p>
      ...
      <footer className="bg-gray-800 text-white py-12">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-xl font-bold mb-4">ResearchConnect</h3>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-gray-400 hover:text-white">Research Guidelines</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white">Funding Best Practices</a></li>
